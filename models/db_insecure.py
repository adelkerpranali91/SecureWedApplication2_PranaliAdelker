...
def init_db():
    ...
    # EMAIL IS UNIQUE
    cur.execute
    ("""CREATE TABLE IF NOT EXISTS users ( id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT UNIQUE NOT NULL, password TEXT NOT NULL, role TEXT NOT NULL DEFAULT 'patient', full_name TEXT NOT NULL,
        phone TEXT NOT NULL, date_of_birth TEXT NOT NULL,address TEXT NOT NULL,emergency_name TEXT NOT NULL,emergency_phone TEXT NOT NULL,insurance_number TEXT);
    """)
    
    #CREATE APPOINTMENT TABLE
    # INPUT IS NOT VALIDATED
    cur.execute("""CREATE TABLE IF NOT EXISTS appointments (
        id INTEGER PRIMARY KEY AUTOINCREMENT,patient_username TEXT NOT NULL,doctor_name TEXT NOT NULL,date TEXT NOT NULL,time TEXT NOT NULL,
...
def create_user(email: str, password: str, role: str = "patient",
    ...
    conn = get_conn()
    cur = conn.cursor()
    #USES -f STRING, VULNERABLE TO SQL INJECTION
    sql = (
...
#apt_id -- INSERTED IN SQL DIRECTLY
...
def get_appointment() -> List[Dict]:
    conn = get_conn()
    cur = conn.cursor()
    # GET APPOINTMENT SORTED BY TIME AND DATE
